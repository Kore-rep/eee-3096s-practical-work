...
HD_PWD='D:/University/EEE3096S/eee-3096s-practical-work/Practical-6/Part-1/Practical6/Practical6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_simple_CPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_simple_CPU.tcl -notrace
