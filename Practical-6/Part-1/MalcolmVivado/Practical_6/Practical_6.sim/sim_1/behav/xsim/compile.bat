...
REM
REM Generated by Vivado on Fri Nov 05 17:28:48 +0200 2021
...
echo "xvlog --incr --relax -prj tb_simple_CPU_vlog.prj"
call xvlog  --incr --relax -prj tb_simple_CPU_vlog.prj -log xvlog.log
